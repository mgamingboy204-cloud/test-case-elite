...
export default function OnboardingLayout({ children }: { children: ReactNode }) {
  ...
  if (!isAuthResolved) {
    return <div className="w-full app-height bg-background" />;
  }
  ...
  return (
    <div className="w-full app-height bg-background overflow-hidden relative flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-[420px] app-height flex flex-col bg-background/90 backdrop-blur-xl border-x border-primary/10 overflow-hidden">
