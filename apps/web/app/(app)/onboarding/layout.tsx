...
export default function OnboardingLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="w-full min-h-screen bg-background relative flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-[420px] min-h-screen min-[769px]:h-screen flex flex-col bg-background/90 backdrop-blur-xl border-x border-primary/10 overflow-hidden">
